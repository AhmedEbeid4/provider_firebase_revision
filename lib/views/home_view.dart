        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
                  ...
                  IconButton(
                      onPressed: () {
                        Navigator.of(context)
                            .pushReplacementNamed(StartView.routeName);
                      },
                  ...
                  Expanded(
                    child: Autocomplete<String>(
                      optionsBuilder: (value) {
                        ...
                        return provider.currData.where((element) => element
                            .toLowerCase()
              ...
              Consumer<ProviderExample>(builder: (ctx, pro, child) {
                if (pro.isLoading) {
                  ...
                  IconButton(
                      onPressed: () {
                        if (_controller.text.isNotEmpty) {
                          provider.add(_controller.text.trim());
                          _controller.text = '';
                        }
                      },
